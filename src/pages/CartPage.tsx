                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 md:p-5">
                          ...
                          <div className="flex items-center justify-end w-full sm:w-auto mt-2 sm:mt-0">
                            <button
                              ...
                              className="flex items-center gap-1.5 px-3.5 py-2 border border-slate-200 text-slate-600 hover:text-red-500 hover:border-red-200 rounded-xl text-xs font-bold transition-all bg-white hover:bg-red-50 shadow-sm"
                              title="Remove item"
                            >
